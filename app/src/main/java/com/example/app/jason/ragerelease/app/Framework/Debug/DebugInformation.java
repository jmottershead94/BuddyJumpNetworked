...
{
    // Attributes.
    public static final int NO_MESSAGE_BOX = 0;         // This is the result number used to show that there is no message box currently.
    public static final int ACCEPTED_MESSAGE = 1;       // This will tell us if the user has pressed the positive option from the message box.
    public static final int DECLINED_MESSAGE = 2;       // This will tell us if the user has pressed the negative option from the message box.
    ...
    public static void displayMessageBox(final Context context, final String title, final String message, final String positiveOption, final String negativeOption)
    {
        ...
        // Setting whether or not we can cancel out from this message box or not.
